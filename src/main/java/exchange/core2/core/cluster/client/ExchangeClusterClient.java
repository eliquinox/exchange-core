...
@Slf4j
public class ExchangeClusterClient implements EgressListener {
    ...
    public void onMessage(
        ...
        /**
         * A work-around for retrieving cluster responses - will be redone in future.
         *
         * Better way: retain a map of client session objects (e.g. Http or WS sessions)
         * and return appropriately serialised cluster response via these objects to end client.
         *
         * In essence, the mechanism needs to be lazy - it should send back the end response only once and only when it
         * has to.
         */
